...
class UsersSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            ['user_id' => 3, 'first_name' => 'Kristine', 'middle_name' => 'D.', 'last_name' => 'Hilarious', 'email' => 'hilarious@email.com', 'phone_number' => '9123456789', 'address' => 'Davao City', 'password' => Hash::make('pass1234'), 'role' => 'customer', 'created_at' => $now, 'updated_at' => $now],
