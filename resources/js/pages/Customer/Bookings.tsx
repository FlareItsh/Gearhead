            ...
            filteredBookings.map((b) => (
              ...
              >
                <div className="flex justify-between text-lg">
                  ...
                  <div className="font-bold">₱{b.total_amount.toLocaleString()}</div>
                </div>

                <div>{new Date(b.order_date).toLocaleString()}</div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    >
                      {b.order_status.replace('_', ' ').replace(/^\w/, (c) => c.toUpperCase())}
                    </Badge>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6 text-center">
                <div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-full bg-highlight/20">
                  {(() => {
                    ...
                    return <Icon className="h-6 w-6 text-highlight" />
                  })()}
                </div>
          ...
          >
            ...
            >
              ...
              <div className="mb-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-foreground">Confirm Cancellation</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {new Date(bookingToCancel.order_date).toLocaleString()}
                    </p>
                  </div>
                </div>
