...
const CustomerDashboard: React.FC = () => {
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      ...
      const [timeStr, period] = pendingBooking.time.split(' ')
      ...
      // Get variant_ids from services
      const variantIds = pendingBooking.services.map((s) => s.selectedVariant.service_variant)
                ...
                >
                  <div>
                    <HeadingSmall
                      ...
                      description={new Date(booking.order_date).toLocaleString()}
                    />
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    >
                      {booking.status.replace('_', ' ').replace(/^\w/, (c) => c.toUpperCase())}
                    </Badge>
                  </div>
                </div>
              ))
                ...
                >
                  <div>
                    <HeadingSmall
                      ...
                      description={new Date(payment.date).toLocaleString()}
                    />
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <span className="text-lg font-bold">Amount: ₱{payment.amount}</span>
